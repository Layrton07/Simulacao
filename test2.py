...
class ModeloPropagacaoGuerraEPandemia:
    ...
    def simulation(self, geracoes):
        for i in range(geracoes):
            ...
            # Subtrair o número total de mortes do número total de soldados
            totalSoldados -= totalMortos
            ...
            # Atualize o tamanho da população na próxima geração
            self.populacao = []
            for _ in range(totalSoldados):
                linha = []
                for _ in range(totalSoldados):
                    # Inicialmente, todos os soldados estão saudáveis
                    linha.append(Soldado(Estado.saudavel))
